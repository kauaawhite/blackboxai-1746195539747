# Two-Person Chatting Website Like WhatsApp with Admin Panel

## Project Structure

- backend/: Node.js server with Express and Socket.IO for real-time messaging
...
- Real-time two-person chat using Socket.IO
...
- The admin panel UI and features can be added as needed.
